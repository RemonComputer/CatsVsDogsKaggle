...
if __name__ == '__main__':
    ...
    model.train(optimizer, train_dataset, test_dataset, train_batch_size = 128, test_batch_size = 128, no_ephocs = 50, model_save_intervals_in_ephocs = 2, test_accuracy_interval_in_batches = 10)
