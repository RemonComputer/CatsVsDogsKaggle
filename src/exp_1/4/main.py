...
if __name__ == '__main__':
    ...
    model.train(optimizer, augmented_train_dataset, test_dataset, train_batch_size = 32, test_batch_size = 32, no_ephocs = 5, model_save_intervals_in_ephocs = 2, test_accuracy_interval_in_batches = 10, no_test_batches = 10)
